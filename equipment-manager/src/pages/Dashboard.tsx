...
import type { DeptCard, DeptCardRequest } from '@shared/ipc'
import {
  IconBox, IconCheck, IconWrench, IconAlert, IconReturn, IconBuilding
} from '@/lib/icons'
import { requestStatusLabel } from '@/lib/status'

const PAGE_SIZE = 6

// Stat card definitions
const STAT_DEFS = [
  { label: 'Tổng thiết bị', key: 'total' as const, Icon: IconBox, color: 'var(--primary)', tint: 'var(--primary-tint)' },
  { label: 'Đang cấp phát', key: 'allocated' as const, Icon: IconCheck, color: '#16a34a', tint: 'rgba(22,163,74,.14)' },
  { label: 'Đang bảo trì', key: 'maintenance' as const, Icon: IconWrench, color: '#ca8a04', tint: 'rgba(202,138,4,.18)' },
  { label: 'Hỏng/Thanh lý', key: 'broken' as const, Icon: IconAlert, color: '#dc2626', tint: 'rgba(220,38,38,.14)' },
]
    ...
    <div style={{
      ...
      {req && (
        <div style={{
          ...
          <span>{req.requester} · {req.date} · {req.items.length} thiết bị</span>
